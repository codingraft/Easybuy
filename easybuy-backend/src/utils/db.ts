...
export const invalidateCache = async({product, admin, order, userId, orderId, productId }: InvalidCacheProps) => {
  if(product) {
    const productKeys: string[] = ["latestProducts", "categories", "allProducts, `product-${productId}`"];
